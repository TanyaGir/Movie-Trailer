...
finding_dory = media.Movie(
    "Finding Dory",
    "The story about a fish with who sets out to find her parents",
...
beauty_and_the_beast = media.Movie(
    ...
    ("https://upload.wikimedia.org/wikipedia/en/d/d6/"
     "Beauty_and_the_Beast_2017_ poster.jpg"),
...
'''open_movies_page is a function in fresh_tomatoes.py that takes in one
argumentwhich is the list of movies'''
